...
?>
    <div id="form_edit" class="container form_edit" style="width:35%;padding-bottom:100px;padding-top:100px;">
      ...
      <form action="editar.php" method="post" >
          ...
          <label>Modelo de trabalho : </label> <input class="common-input mb-20 form-control" type="text" name="modelo" id="nome" value="<?php echo $modeloDeTrabalho;?>"><br>
